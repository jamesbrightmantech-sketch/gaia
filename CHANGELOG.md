...
- Bump [go.opentelemetry.io/otel/metric](https://github.com/open-telemetry/opentelemetry-go) from 1.37.0 to 1.44.0 ([#17](https://github.com/jamesbrightmantech-sketch/gaia/pull/17))
